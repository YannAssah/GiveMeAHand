...
<html>
<head>
    <title>Computers - Planning</title>
    ...
    <div class="row">
        <div class="col-md-3">
            <ul class="nav nav-pills nav-stacked admin-menu">
                ...
                <li><a href="solutions.php" data-target-id="widgets"><i class="fa fa-list-alt fa-fw"></i>Solutions et Services</a></li>
                <li class="active"><a href="./computers.php" data-target-id="pages"><i class="fa fa-file-o fa-fw"></i>Computers</a></li>
            </ul>
        </div>
    </div>
</div>
            ...
            <script>
                $(document).ready(function() {
                    ...
                    var calendar = $('#calendar').fullCalendar({
                        events: "http://5.135.145.108/midrange/planning/fullcalendar/event2.php",
                        ...
                        select: function(start, end, allDay) {
                            ...
                            if (title) {
                                ...
                                $.ajax({
                                    url: 'http://5.135.145.108/midrange/planning/fullcalendar/add_events2.php',
                        ...
                        eventDrop: function(event, delta) {
                            ...
                            $.ajax({
                                url: 'http://5.135.145.108/midrange/planning/fullcalendar/events-update2.php',
                        ...
                        eventClick: function(event) {
                            ...
                            if (confirm("Voulez-vous vraiment supprimer ?")) {
                                $.ajax({
                                    url: 'http://5.135.145.108/midrange/planning/fullcalendar/delete_events2.php',
                                    data: 'title='+ event.title+'&start='+ start +'&end='+ end +'&id='+ event.id ,
                                    type: "POST",
                                    success: function(json) {
                                        alert("Fait !");
